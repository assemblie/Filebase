...
class QueryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSorting()
    {
        ...
        $this->assertEquals(
            ['first'=>'Amazon','second'=>'Amex','last'=>'Microsoft'],
            ['first'=>$test1[0]['name'],'second'=>$test1[1]['name'],'last'=>$test1[5]['name']]
        );
